...
const dropdownContent = {
  ...
  Pages: ['About Us', 'FAQ', 'Pricing Table', 'Team', 'Team Details', 'Company history', 'Coming soon', 'error 404', 'Site Down'],
  Services: ['Services', 'Services Details'],
  'Post Layout': {
  'Side Bar': ['Post Left Sidebar', 'Post Right Sidebar', 'Post Both Sidebar NEW', 'Post No Sidebar'],
  'Post Types': ['Text Post NEW', 'Image Post', 'Post Video', 'Post Link', 'Post Audio', 'Post Quote NEW', 'Tutorial Post NEW', 'Cateloge Post NEW'],
  'Multiple Media': ['Banner', 'Post Slide Show NEW', 'Gallery', 'Status Slider NEW'],
 ...
 {navItems.map(({ label, active }) => (
    ...
    <Fade in={openDropdown === label} timeout={300}>
      <Box
        sx={{
          ...
          transform: label === 'Post Layout' ? 'translateX(-50%)' : 'none',
          backgroundColor: '#fff',
  ...
  >
    {Object.entries(dropdownContent['Post Layout']).map(([section, items]) => (
